...
map <Down> gj		"as above, move down one screen line"
map <Up> gk		"move up one screen line (might be broken to fit display)"
inoremap  u
...
set scrolloff=5
set sessionoptions=blank,buffers,curdir,folds,help,options,tabpages,winsize,terminal,resize,localoptions,options,winpos
set shiftwidth=6
set showcmd
set showmatch
set softtabstop=4
...
edit css/stylish-portfolio.css
...
11
normal! 0
lcd ~/dev/cv-page/site
wincmd w
argglobal
if bufexists("~/dev/cv-page/site/index.html") | buffer ~/dev/cv-page/site/index.html | else | edit ~/dev/cv-page/site/index.html | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 3resize ' . ((&columns * 94 + 75) / 150)
tabnext 1
badd +302 ~/dev/cv-page/site/css/stylish-portfolio.css
badd +1 ~/new.js
badd +30 ~/dev/cv-page/site/index.html
badd +32 ~/dev/cv-page/site/index.vim
badd +31 ~/dev/cv-page/site/stylish1.vim
badd +1 ~/dev/cv-page/site
badd +1 ~/dev/cv-page/site/.gitignore
badd +75 ~/.vimrc
badd +2 ~/dev/cv-page/site/package.json
if exists('s:wipebuf') && len(win_findbuf(s:wipebuf)) == 0
  silent exe 'bwipe ' . s:wipebuf
endif
unlet! s:wipebuf
set winheight=8 winwidth=8 shortmess=filnxtToO
set winminheight=8 winminwidth=1
